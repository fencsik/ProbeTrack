### data01: aggregate accuracy and RT statistics by subject probe type, and
### probe delay
...
### extract factors for all trials and for all correct trials
    ...
    factorsA <- with(data00, list(soa=soa, target=target, sub=sub))
    factorsC <- with(dataCC, list(soa=soa, target=target, sub=sub))
