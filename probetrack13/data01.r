### data01: aggregate accuracy and RT statistics by subject, condition,
### probe type, and probe delay
...
### extract factors for all trials and for all correct trials
    ...
    factorsA <- with(data00, list(soa=soa, target=target, cond=gaptype, sub=sub))
    factorsC <- with(dataCC, list(soa=soa, target=target, cond=gaptype, sub=sub))
