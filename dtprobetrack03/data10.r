### data10: aggregate median correct RT by subject, condition, gap
### duration, tracking load, and probe delay
...
f.data10 <- function () {
    ...
    factorsC <- with(dt2, list(soa=soa, cond=stdt, gapdur=gapdur, sub=sub))
