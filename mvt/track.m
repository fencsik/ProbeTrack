...
%%%
%%% $Id: track.m,v 1.19 2004/08/20 14:04:20 fencsik Exp $
...
defaults = {'xxx', '2', 'prac2A1', 'exp2A1', '0', '0', '0'};
...
fprintf(dataFile,'experiment,sub,time,pracfile,pathfile,blocktype,trialtype,trialdur,blankdur,trial,line,speed,ndisks,ntargets,framedur,error,nerrors\n');
fclose(dataFile);
...
%%%       end;
      ...
      % save data
      dataFile = fopen(dataFileName, 'a');
      %header = experiment,sub,time,pracfile,pathfile,blocktype,trialtype,trialdur,blankdur,trial,line,speed,ndisks,ntargets,framedur,error,nerrors
