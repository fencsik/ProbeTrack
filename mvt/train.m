...
%%%
%%% $Id: train.m,v 1.8 2004/05/12 17:37:00 fencsik Exp $
...
ExperimentName = 'ShiftTrack4Train';
minimumAccuracy = '60%';
...
fprintf(dataFile,'experiment,sub,time,pathfile,blocktype,shift,trialdur,blankdur,trial,line,speed,ndisks,ntargets,framedur,error,nerrors\n');
fclose(dataFile);
...
for block = 1
   ...
   for trial = trials
      ...
      % save data
      dataFile = fopen(dataFileName, 'a');
      %header = experiment,sub,time,pathfile,blocktype,shift,trialdur,blankdur,trial,line,speed,ndisks,ntargets,framedur,error,nerrors\n');
